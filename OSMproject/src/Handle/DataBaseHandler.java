...
public class DataBaseHandler implements InsertData {
	...
	{	
		String ways = "CREATE TABLE IF NOT EXISTS ways(ID TEXT PRIMARY KEY NOT NULL,"
				+ "version TEXT,"
				+ "timestamp TEXT,"
				+ "uid TEXT,"
				+ "user TEXT,"
		...
		String relations = "CREATE TABLE IF NOT EXISTS relations(ID TEXT PRIMARY KEY NOT NULL,"
				+ "version TEXT,"
				+ "timestamp TEXT,"
				+ "uid TEXT,"
				+ "user TEXT,"
		...
		String relations_tags = "CREATE TABLE IF NOT EXISTS relations_tags(relation_id TEXT, tag_key TEXT, tag_value TEXT)";
		
		String relations_members = "CREATE TABLE IF NOT EXISTS relations_members(relation_id TEXT,"
				+ "member_type TEXT,"
				+ "member_ref TEXT,"
				+ "member_role TEXT)";
		...
		String nodes_tags = "CREATE TABLE IF NOT EXISTS nodes_tags(nodes_id TEXT, tag_key TEXT, tag_value TEXT)";
