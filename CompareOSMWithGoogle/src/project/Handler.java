...
public class Handler {
	...
	public void generate100Routes () throws Exception{
		...
		while(rs.next()){
			...
			ps.setString(6, lat2);
			ps.setString(7, lon2);
			int timeGraphopper = sendRequestToGraphhopper(decimal3(lat1),decimal3(lon1),decimal3(lat2),decimal3(lon2));
			ps.setString(8, msToHour(timeGraphopper));
			String timeGoogle = sendRequestToGoogle(decimal3(lat1),decimal3(lon1),decimal3(lat2),decimal3(lon2));
	...
	public String decimal3(String s){
		double d = Double.parseDouble(s);
		DecimalFormat df = new DecimalFormat("0.000");
		df.format(d);
		String decimal3 = Double.toString(d);
		return decimal3;
	}
